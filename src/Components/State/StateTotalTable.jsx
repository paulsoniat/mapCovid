...
const StateTotalTable = ({
  ...
  return (
    ...
    {data.map((item, index) => {
        ...
        return <div key={index} style={{width: "100%", display: "flex", flexDirection: "column", "backgroundColor": "black", "boxSizing": "border-box", "margin": ".5rem 0rem .5rem 0rem", "padding": "1rem", "borderRadius": ".5rem", "font-size": "1.5rem" }}>
